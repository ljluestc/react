...
import {TimelineSearchContext} from './TimelineSearchContext';type Props = {};export default function TimelineSearchInput(props: Props): React.Node {
...
dispatch({type: 'GO_TO_PREVIOUS_SEARCH_RESULT'});  return createPortal(
<SearchInput
