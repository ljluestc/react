...
import type {Size} from './geometry';import memoize from 'memoize-one';import {View} from './View';
import {zeroPoint} from './geometry';
import {DPR} from '../content-views/constants';export type ViewRefs = {
...
export class Surface {
  ...
  _canvasSize: ?Size;  _resetHoveredEvent: ResetHoveredEventFn;  _viewRefs: ViewRefs = {
activeView: null,
hoveredView: null,
...
this._canvasSize = canvasSize;if (this.rootView) {
...
viewRefs.hoveredView = null;rootView.handleInteractionAndPropagateToSubviews(
interaction,
viewRefs,
