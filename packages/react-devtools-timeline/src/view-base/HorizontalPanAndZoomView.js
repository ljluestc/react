...
} from './constants';export class HorizontalPanAndZoomView extends View {
  _contentView: View;
...
this._viewState = viewState;viewState.onHorizontalScrollStateChange(scrollState => {
...
rangeStart,
rangeEnd,
contentLength: this._intrinsicContentWidth,minContentLength: this._intrinsicContentWidth * MIN_ZOOM_LEVEL,
maxContentLength: this._intrinsicContentWidth * MAX_ZOOM_LEVEL,
containerLength: this.frame.size.width,
});
...
this._isPanning = true;viewRefs.activeView = this;this.currentCursor = 'grabbing';
}
...
fixedPoint: location.x - this._viewState.horizontalScrollState.offset,minContentLength: this._intrinsicContentWidth * MIN_ZOOM_LEVEL,
maxContentLength: this._intrinsicContentWidth * MAX_ZOOM_LEVEL,
containerLength: this.frame.size.width,
});
this._viewState.updateHorizontalScrollState(newState);
