 ...
 */import {
  ...
  translateState,
  zoomState,
} from '../scrollState';describe(clampState, () => {
...
state: {offset: 0, length: 100},
multiplier: 1.5,
fixedPoint: 0,minContentLength: 0,
...
state: {offset: -20, length: 100},
multiplier: 0.1,
fixedPoint: 5,minContentLength: 50,
maxContentLength: 100,
containerLength: 50,
});
...
const offset = -20;
const fixedPointFromContainer = 10;const zoomedState = zoomState({
state: {offset, length: 100},
multiplier: 2,
fixedPoint: fixedPointFromContainer - offset,minContentLength: 0,
maxContentLength: 1000,
containerLength: 50,
...
rangeStart: 50,
rangeEnd: 100,
contentLength: 400,minContentLength: 10,
maxContentLength: 1000,
containerLength: 50,
