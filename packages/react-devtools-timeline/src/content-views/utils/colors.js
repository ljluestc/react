 ...
 *
 * @flow
 */type ColorSpace = number | {min: number, max: number, count?: number};// Docstrings from https://www.w3schools.com/css/css_colors_hsl.asp
...
export class ColorGenerator {
  ...
  _colors: Map<string, HslaColor>;  constructor(
hueSpace?: ColorSpace,
satSpace?: ColorSpace,
