 ...
 *
 * @flow
 */import type {Rect, Size} from '../view-base';import {
  durationToWidth,
...
import {
  ...
  BORDER_SIZE,
} from './constants';const HEADER_HEIGHT_FIXED = MARKER_HEIGHT + BORDER_SIZE;
const LABEL_FIXED_WIDTH = LABEL_SIZE + BORDER_SIZE;export class TimeAxisMarkersView extends View {
  _totalDuration: number;
  _intrinsicSize: Size;  constructor(surface: Surface, frame: Rect, totalDuration: number) {
super(surface, frame);
...
break; // Not in view
}const markerLabel = Math.round(markerTimestamp);context.fillStyle = COLORS.PRIORITY_BORDER;
context.fillRect(
x,
