 ...
 *
 * @flow
 */import {useLayoutEffect, useRef} from 'react';const TOOLTIP_OFFSET_BOTTOM = 10;
const TOOLTIP_OFFSET_TOP = 5;export default function useSmartTooltip({
  canvasRef,
  mouseX,
  mouseY,
}: {
  ...
  const ref = useRef<HTMLElement | null>(null);  // HACK: Browser extension reports window.innerHeight of 0,
