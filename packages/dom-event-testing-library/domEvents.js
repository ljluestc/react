 ...
 */function emptyFunction() {}function createEvent(type, data = {}) {
...
y = 0,
  ...
  const isMouse = pointerType === 'mouse';  return createEvent(type, {
altKey,
button,
buttons,
clientX: x,
...
shiftKey = false,
  ...
  const modifierState = {altKey, ctrlKey, metaKey, shiftKey};  return createEvent(type, {
altKey,
ctrlKey,
getModifierState(keyArg) {
  return createGetModifierState(keyArg, modifierState);
