...
let assertLog;beforeEach(() => {
  ...
  assertLog = InternalTestUtils.assertLog;  Suspense = React.Suspense;
  if (gate(flags => flags.enableSuspenseList)) {
SuspenseList = React.unstable_SuspenseList;
  }  getCacheForType = React.unstable_getCacheForType;  caches = [];
  seededCache = null;
...
textCache.data.set(text, newRecord);throw thenable;
  }
}function Text({text}) {
  Scheduler.log(text);
...
}const resolveText = resolveMostRecentTextCache;// @gate enableLegacyCache
