...
let ReactTestUtils;
let act;
let SuspenseList;function initModules() {
  // Reset warning cache.
...
ReactTestUtils,
  ...
  ReactDOMServerIntegrationUtils(initModules);describe('ReactDOMServerSuspense', () => {
  beforeEach(() => {
resetModules();
  });  function Text(props) {
...
expect(divB.textContent).toBe('B');await act(() => {
