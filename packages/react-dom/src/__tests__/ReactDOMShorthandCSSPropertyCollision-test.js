 ...
 *
 * @emails react-core
 */  let ReactDOReact = require('react');
ReactDOM = require('react-dom');
  });  it('shouReactDOM.render(<div style={{font: 'foo', fontStyle: 'bar'}} />, container);
expect(() =>
ReactDOM.render(<div style={{font: 'foo'}} />, container),
).toErrorDev(
'Warn"bugs. To avoid this, don't mix shorthand and non-shorthand " +
...
ReactDOM.render(<div style={{font: 'foo', fontStyle: 'baz'}} />, container);expect(() =>
ReactDOM.render(
<div style={{font: 'qux', fontStyle: 'baz'}} />,
container,
),
).toErrorDev(
'Warni"bugs. To avoid this, don't mix shorthand and non-shorthand " +
'properties for the same value; instead, replace the shorthand ' +
'with separate values.' +);
expect(() =>
