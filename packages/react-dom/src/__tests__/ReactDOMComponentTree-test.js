 ...
 *
 * @emails react-core
 */'use strict';describe('ReactDOMComponentTree', () => {
  let React;
  let ReactDOM;
...
let currentTargetID = null;class ClosestInstance extends React.Component {
_onClick = e => {
currentTargetID = e.currentTarget.id;
};
render() {
...
const handlerB = () => (action = 'B');function simulateMouseOver(target) {
...
const finishValue = 'finish';class Controlled extends React.Component {
...
'value',
).set;function simulateInput(elem, value) {
