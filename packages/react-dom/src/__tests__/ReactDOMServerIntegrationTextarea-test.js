...
}const {resetModules, itRenders} = ReactDOMServerIntegrationUtils(initModules);describe('ReactDOMServerIntegrationTextarea', () => {
  beforeEach(() => {
resetModules();  // ---------
...
expect(e.getAttribute('value')).toBe(null);
expec  });  itRenders('a textarea value overriding defaultValue', async render => {
