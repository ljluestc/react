...
const ReactDOM = require('react-dom');describe('dangerouslySetInnerHTML', () => {
...
let innerHTMLDescriptor;// In some versions of IE (TODO: which ones?) SVG nodes don't have
...
// back to using appendChild and removeChild.beforeEach(() => {
...
it('clears previous children', () => {
  ...
  const secondHtml = '<circle></circle>';  const container = document.createElementNS(
'http://www.w3.org/2000/svg',
'svg',
  );
  ReactDOM.render(
