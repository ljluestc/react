...
import {createEventHandle} from 'react-dom-bindings/src/client/ReactDOMEventHandle';import {
  batchedUpdates,
...
import ReactVersion from 'shared/ReactVersion';import {
...
import Internals from '../ReactDOMSharedInternals';export {
  prefetchDNS,
  preconnect,
  preload,
  preinit,
} from '../shared/ReactDOMFloat';
export {useFormStatus} from 'react-dom-bindings/src/shared/ReactDOMFormActions';if (__DEV__) {
  if (
typeof Map !== 'function' ||
