...
let ReactDOM;describe('getEventKey', () => {
...
}ReactDOM.render(<Comp />, container);const nativeEvent = new KeyboardEvent('keydown', {
  key: 'Del',
  bubbles: true,
  cancelable: true,
});
...
render() {
  ...
  }  ReactDOM.render(<Comp />, container);  const nativeEvent = new KeyboardEvent('keypress', {
charCode: 13,
bubbles: true,
cancelable: true,
  });
