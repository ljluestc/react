'use strict';const Git = require('nodegit');
const rimraf = require('rimraf');
const ncp = require('ncp').ncp;
const {existsSync} = require('fs');
const exec = require('child_process').exec;
const {join} = require('path');const reactUrl = 'https://github.com/facebook/react.git';function cleanDir() {
...
await repo.getBranchCommit('main')
  ...
  let repo;
  const remoteRepoDir = getDefaultReactPath();  if (!skipBuild) {
if (clean) {
