...
const Table = require('cli-table');function percentChange(prev, current, prevSem, currentSem) {
...
currentSem
  ...
  const ci95 = +(100 * 1.96 * sd).toFixed(1);  const ciInfo = ci95 > 0 ? ` +- ${ci95} %` : '';
...
table.push(rowHeader);const measurements =
