#!/usr/bin/env node'use strict';const commandLineArgs = require('command-line-args');
const getBuildIdForCommit = require('./get-build-id-for-commit');
const theme = require('../theme');
const {logPromise} = require('../utils');const paramDefinitions = [
  {
name: 'build',
type: String,
description:
...
defaultValue: false,
  ...
  const params = commandLineArgs(paramDefinitions);  const channel = params.releaseChannel;
  if (
